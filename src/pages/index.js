...
export default () => (
  <div>
    <Layout>  
        ...
        <p>
          For <strong>7 months</strong> of 2019 I was lucky enough to intern at <strong>Nokia</strong> in the Bay Area, where I had the time of my life going to 
        ...
        <p>
          This summer I will be interning at <strong>Cisco</strong> as a software engineer, where I hope to make tangible contributions
